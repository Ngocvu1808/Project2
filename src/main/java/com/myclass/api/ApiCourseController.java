...
public class ApiCourseController {
	...
	public Object getDiscount() {
		...
		List<Course> course = courseRepository.findCourseDiscount();
		return new ResponseEntity<List<Course>>(course, HttpStatus.OK);
	}
	...
	public Object getNotDiscount() {
		...
		List<Course> course = courseRepository.findCourseNotDiscount();
		return new ResponseEntity<List<Course>>(course, HttpStatus.OK);
	}
	...
	public Object search(@RequestParam String keyword) {
		List<Course> course = courseRepository.findByDes(keyword);
		return new ResponseEntity<List<Course>>(course, HttpStatus.OK);
