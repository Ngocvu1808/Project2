...
public interface UserCourseRepository extends JpaRepository<UserCourse, Integer> {
	...
	void deleteByCourseIdAndUserID(@Param("course_id")int course_id, @Param("user_id") int user_id);
	
	@Transactional
	@Query("FROM UserCourse  WHERE  user_id=:user_id and course_id=:course_id")
	UserCourse findByCourseIdAndUserID(@Param("course_id")int course_id, @Param("user_id") int user_id);
